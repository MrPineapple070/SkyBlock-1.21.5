...
public record GiantKillerEffect(EnchantmentLevelBasedValue level) implements EnchantmentEntityEffect {
    public static MapCodec<GiantKillerEffect> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
            EnchantmentLevelBasedValue.CODEC.fieldOf("level").forGetter(GiantKillerEffect::level)
    ).apply(instance, GiantKillerEffect::new));
